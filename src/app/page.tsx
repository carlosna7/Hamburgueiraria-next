  ...
  return (
    <>
      <div className='relative'>
        ...
        <img
          className="z-0 top-0 right-0 sm:w-auto sm:h-full bg-cover h-[450px] object-cover items-center"
          src="../home-img.png"
          alt=""
        />
      ...
      <Section>
        ...
        <div className="lg:flex justify-between justify-items-center grid md:grid-cols-2 md:grid-rows-2 grid-cols-1 grid-rows-3 sm:gap-8 gap-4">
          <div className='flex flex-col items-center 2xl:w-[360px] xl:w-[280px] lg:w-[240px] md:w-[260px] sm:w-[240px] w-[280px] bg-amber-100 text-amber-900 rounded-lg p-4 hover:rounded-3xl hover:bg-amber-900 hover:text-white duration-500'>
          ...
          <div className='flex flex-col items-center sm:col-span-2 2xl:w-[360px] xl:w-[280px] lg:w-[240px] md:w-[260px] sm:w-[240px] w-[280px] bg-amber-100 text-amber-900 rounded-lg p-4 hover:rounded-3xl hover:bg-amber-900 hover:text-white duration-500'>
